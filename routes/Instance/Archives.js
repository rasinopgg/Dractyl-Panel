...
router.post("/instance/:id/archives/create", async (req, res) => {
  ...
  const RequestData = {
    method: "post",
    // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives`,
    url: `http://Dractyl:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives/${instance.VolumeId}/create`,
    headers: {
      "Content-Type": "application/json",
    },
  };
...
router.post("/instance/:id/archives/delete/:archivename", async (req, res) => {
  ...
  const RequestData = {
    method: "post",
    // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives`,
    url: `http://Dractyl:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives/delete/${archivename}`,
    headers: {
      "Content-Type": "application/json",
    },
  };
...
router.post(
  ...
  async (req, res) => {
    ...
    const RequestData = {
      method: "post",
      // url: `http://${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives`,
      url: `http://Dractyl:${instance.Node.apiKey}@${instance.Node.address}:${instance.Node.port}/archive/${instance.ContainerId}/archives/rollback/${instance.VolumeId}/${archivename}`,
      headers: {
        "Content-Type": "application/json",
      },
    };
